  ...
  <div class="container">
    <div class="row">
      <div class="col-sm w3-animate-left">
        ...
        <img
          src="https://i.postimg.cc/8zq0BbVB/contact.jpg"
          alt="me"
          class="abt-image"
        />
      </div>
      ...
      <div class="col-sm w3-animate-right">
        <div class="container">
          <div class="row">
            <div class="col">
              <router-link to="/" class="btn btn-rabbit back-btn mnn ccvv"
                ><i class="fas fa-angle-left bbn"> </i>
                <span class="back2home">Back to Home</span>
              </router-link>
            </div>
          ...
          <div class="row">
            <div class="col">
              <form
                class="form_edit"
                action="https://formspree.io/f/xnqwyraz"
                method="POST"
              >
                <div class="form-group">
                  <input
                    type="name"
                    class="form-control bgg mnnm"
                    id="exampleInputName"
                    placeholder="Name"
                    name="Name"
                  />
                ...
                <a href="http://www.google.com">
                  <button
                    type="submit"
                    class="mnn btn btn-rabbit submit bgg bggn"
                  >
                    Send Message
                  </button>
                </a>
